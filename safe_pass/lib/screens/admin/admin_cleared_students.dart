...
import 'package:safe_pass/screens/admin/admin_elevateAccTypePopout.dart';
import 'package:safe_pass/screens/user/student_userInfo.dart';
import 'package:safe_pass/screens/misc/admin_sideDrawer.dart';

import '../../models/account_model.dart';
import '../../providers/account_provider.dart';

class ClearedStudentList extends StatefulWidget {
  const ClearedStudentList({super.key});

  _ClearedStudentListState createState() => _ClearedStudentListState();
}

class _ClearedStudentListState extends State<ClearedStudentList> {
  ...
  Widget _totalNumberofClearedStudents(int total) {
    return Padding(
  ...
  Widget _studentList(BuildContext context, Account account) {
    Stream<QuerySnapshot<Map<String, dynamic>>> studentListStream =
        context.watch<AccountProvider>().getStudentByStatus("cleared");
    ...
    return StreamBuilder(
        ...
        builder: (context, snapshot) {
          ...
          return Column(
            children: [
              _totalNumberofClearedStudents(no_of_students),
              Divider(),
              Column(
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            showDialog(
                                context: context,
                                builder: ((context) =>
                                    UserInformation(account: student)));
                          },
                        ),
                      ),
                    ),

...
import 'admin_filterPopout.dart';
...
class _StudentListState extends State<StudentList> {
        ...
        actions: <Widget>[
          IconButton(
           ...
           onPressed: () {
              showDialog(
                  context: context,
                  builder: ((context) => FilterPopout(account: account)));
            },
          )
        ],
      ),
  ...
  Widget _totalNumberofStudents(int total) {
    return Padding(
  ...
  Widget _studentList(BuildContext context, Account account) {
    ...
    return StreamBuilder(
        ...
        builder: (context, snapshot) {
          ...
          return Column(
            children: [
              _totalNumberofStudents(no_of_students),
              Divider(),
              Column(

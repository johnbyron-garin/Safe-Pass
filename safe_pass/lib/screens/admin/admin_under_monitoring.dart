...
import 'admin_monitoringPopout.dart';

class UnderMonitoring extends StatefulWidget {
  const UnderMonitoring({super.key});

  _UnderMonitoringState createState() => _UnderMonitoringState();
}

class _UnderMonitoringState extends State<UnderMonitoring> {
  ...
  Widget _totalNumberofStudentsUnderMonitoring(int total) {
    return Padding(
          ...
          child: Padding(
            ...
            child: ListTile(
              ...
              title: Column(
                children: [
                  Text(
                    "Total Number of Students Under Monitoring",
  ...
  Widget _studentList(BuildContext context, Account account) {
    ...
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        ...
        return Column(
          children: [
            _totalNumberofStudentsUnderMonitoring(no_of_students),
            Divider(),
            Column(
                    ...
                    child: Padding(
                      ...
                      child: ListTile(
                        ...
                        onTap: () {
                          showDialog(
                              context: context,
                              builder: ((context) => MonitoringPopout(student: student)));
                        },
                      ),
                    ),
                  ),
